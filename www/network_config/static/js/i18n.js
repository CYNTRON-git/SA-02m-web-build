...
(function () {
  ...
  const DICT = {
    ...
    'SMP (без RT, меньше нагрузка)': 'SMP (non-RT, lower load)',
    'RT (PREEMPT_RT, CODESYS)': 'RT (PREEMPT_RT, CODESYS)',
    ...
    'Коммит (устройство)': 'Device commit',
    'Коммит (GitHub)': 'GitHub commit',
    'Задеплоено': 'Deployed',
    'На GitHub': 'On GitHub',
    'Проверка': 'Checked',
