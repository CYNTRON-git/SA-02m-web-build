...
(function () {
  ...
  const DICT = {
    ...
    'Сохранение…': 'Saving…',
    'Сохранено': 'Saved',
    'Интеграция через alice.cyntron.ru. Пока шлюз Phase 0 не развёрнут, привязка вернёт ошибку — без ложного «успеха».':
      'Integration via alice.cyntron.ru. Until the Phase 0 gateway is deployed, linking returns an error — never a fake success.',
    'Агент': 'Agent',
    ...
    'Архив содержит пароли и ключи. Храните offline. Проверьте SHA-256 manifest после скачивания.': 'The archive contains passwords and keys. Keep it offline. Verify the SHA-256 manifest after download.',
    ...
    'Сбросить': 'Reset',
    'Сброс конфигурации к заводским значениям. Идентификаторы устройства, ключи SSH, облако и калибровка сохраняются.': 'Reset configuration to factory defaults. Device identity, SSH keys, cloud identity, and calibration are preserved.',
