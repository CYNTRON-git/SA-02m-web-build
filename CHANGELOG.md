...
- **«Интерфейсы RS-485 — активность» появляются раньше «Служб».** Фаза первого
  опроса RS-485 сдвинута с 10.5 с на 3 с (одноразовый быстрый запрос списка
  служб — на 4 с). Зазор тяжёлой очереди 2.2 с сохранён (нагрузка на ARM не
  растёт); период опроса RS-485 — прежние 12 с.
