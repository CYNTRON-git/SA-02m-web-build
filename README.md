...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.0.6.26-cyan?style=flat-square"/>
</p>
...
- Локальные порты, которые туннель вправе публиковать, ограничены allow-list'ом на стороне устройства. Контракты: `docs/contracts/cloud-enrollment.md` (сим с облаком), `docs/contracts/cloud-agent-status.md` (форма статус-файла агента на плате).
...
Плата **< 1.0.5.75** (не видит новых версий) или **< 1.0.5.60** без интернета —
пути «Мост самообновления» / «Офлайн-вариант» в `docs/deployment.md` → «Полный деплой».
