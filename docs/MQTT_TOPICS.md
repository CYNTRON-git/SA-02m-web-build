...
Ключевые коды (0x0000–0x0026, соответствуют `AI_SENSOR_CODES` в `MR-02m-flasher/module_profiles.py`):

| Код (hex/dec) | Тип | Единицы | Масштаб reg+3 |
|---------------|-----|---------|---------------|
| 0x0000 / 0 | Выключен | — | — |
| 0x0001 / 1 | NTC 10k (B3950) | °C | ×0.1 |
| 0x0002 / 2 | Pt1000 (α385) | °C | ×0.1 |
| 0x0003 / 3 | Pt100 (α385) | °C | ×0.1 |
| 0x0004 / 4 | Напряжение 0–10 В | V | ×0.001 |
| 0x0005 / 5 | Ток 4–20 мА | mA | ×0.01 |
| 0x0006 / 6 | Термопара K (ТХА) | °C | ×0.1 |
| 0x0007 / 7 | Сухой контакт | — | ×1 (0/1) |
| 0x0015 / 21 | Ток 0–5 мА | mA | ×0.01 |
| 0x0016 / 22 | Ток 0–20 мА | mA | ×0.01 |
| 0x0017 / 23 | Дифф. напряжение ±50 мВ | mV | ×1 |
| 0x0018 / 24 | Дифф. напряжение ±2 В | V | ×0.001 |
| 0x001C / 28 | Pt100 (α385), 3-пров. | °C | ×0.1 |
| 0x001E / 30 | Pt1000 (α385), 3-пров. | °C | ×0.1 |
| 0x0026 / 38 | Напряжение 0–30 В | V | ×0.01 |

Коды 0x0008–0x0014, 0x001B–0x001F, 0x0020–0x0025 — другие RTD/NTC, шкала °C ×0.1.
