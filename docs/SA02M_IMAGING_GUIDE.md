...
Текущий этап — 2 (производство).

### Этап 1 — MVP (выполнен, 2026-09)
...
- [x] Пробная заливка на вторую плату + QA по §14.4 — штатная процедура с 2026-08-18
  (`docs/deployment.md` «Подготовка золотого образа»; две платы залиты 2026-09-16 —
  `docs/bugs/BUGLOG.md` 2026-09-16 12:40)
